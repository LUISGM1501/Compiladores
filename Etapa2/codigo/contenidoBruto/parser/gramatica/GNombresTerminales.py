...
Archivo: GNombresTerminales.py

Breve Descripcion: Nombres de terminales generado por GikGram, traducido
por los estudiantes.
"""

# Parte del módulo Gramatica

class GNombresTerminales:
    """
    ...
    def getNombresTerminales(numTerminal):
        ...
        @param numTerminal
            Número del terminal
        """
        return GNombresTerminales.NombresTerminales[numTerminal]