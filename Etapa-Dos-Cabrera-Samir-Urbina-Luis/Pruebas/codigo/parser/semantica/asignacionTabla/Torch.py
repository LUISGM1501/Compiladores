...
def welcomeTorch(actual, tipo, asignacion):
    ...
    if len(asignacion) == 1 and asignacion[0].type == "PUNTO_Y_COMA":
        # Declaración sin inicialización: Torch variable;
        print(f"Declaración sin inicialización de variable Torch: {actual.lexema}")
        mi_simbolo = Simbolo(
        ...
        # Declaración con inicialización: Torch variable = valor;
