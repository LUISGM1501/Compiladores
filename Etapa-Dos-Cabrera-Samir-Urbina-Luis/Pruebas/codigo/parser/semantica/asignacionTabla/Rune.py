...
def welcomeRune(actual, tipo, asignacion):
    ...
    if len(asignacion) == 1 and asignacion[0].type == "PUNTO_Y_COMA":
        # Declaración sin inicialización: Rune variable;
        print(f"Declaración sin inicialización de variable Rune: {actual.lexema}")
        mi_simbolo = Simbolo(
        ...
        # Declaración con inicialización: Rune variable = valor;
